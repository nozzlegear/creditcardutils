...
interface ICreditCardUtils
{
    ...
    parseCardType(input: string): "visa" | "mastercard" | "amex" | "dinersclub" | "discover" | "unionpay" | "jcb" | "visaelectron" | "maestro" | "forbrugsforeningen" | "dankort";
...
declare var creditcardutils: ICreditCardUtils;
